  ...
  $.ajax({
    ...
    success: function(msg) {
      ...
      for(var i=0;i<msg.data.length;i++){
       str_='<div class="col-sm-6 col-md-2"><div class="thumbnail"><img src="'+msg.data[i].img_path+'" onclick=keyword_os(this) alt="通用的占位符缩略图"><div class="caption text-left"><p class="product_name"><a val="'+ msg.data[i].name +'" onclick=keyword_os(this)>'+
