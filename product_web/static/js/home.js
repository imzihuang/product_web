  ...
  $.ajax({
    ...
    success: function(msg) {
      ...
      for(var i=0;i<msg.data.length;i++){
       ...
       '<div class="likeList"><img src="img/start.png" class="startimg"/><a ><img src="img/unlike.png" id="'+msg.data[i].id+'" onclick="like()"></a><span class="likecount">'+(parseInt(msg.data[i].like_count)+parseInt(msg.data[i].like_add_count))+'</span></div>'+
...
function search(){
  ...
  if(tag==""){
    for(var i=0;i<dataAll.data.length;i++){
      ...
      '<p class="aboutHelp"><a onclick="howclaim()">How to buy?</a></p>'+
      '<div class="likeList"><img src="img/start.png" class="startimg"/><a ><img src="img/unlike.png" id="'+dataAll.data[i].id+'" onclick="like()"></a><span class="likecount">'+dataAll.data[i].like_count+'</span></div>'+
