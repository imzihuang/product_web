  ...
  $.ajax({
    ...
    success: function(msg) {
            ...
            for(var i=0;i<msg.data.length;i++){
             ...
             '<div class="likeList"><span><img src="img/start.png" class="startimg"/></span><span class="likecount">'+msg.data[i].like_count+'</span><a ><img src="img/unlike.png" id="'+msg.data[i].id+'"></a></div></div></div></div>'+
