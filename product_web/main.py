...
def view_handlers():
    ...
    return [
        ...
        (prefix + r'(.*\.(css|png|gif|jpg|js|ttf|woff))', StaticFileHandler, {'path': default_settings.get('static_path')}),
        ...
        (man_prefix + r'(.*\.(css|png|gif|jpg|js|ttf|woff))', StaticFileHandler, {'path': default_settings.get('static_path')}),
    ]
